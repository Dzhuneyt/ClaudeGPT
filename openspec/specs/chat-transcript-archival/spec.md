# chat-transcript-archival Specification

## Purpose

Persist each ended chat session as durable, greppable artifacts inside its session folder — the raw JSONL, a clean markdown transcript, and metadata — in a layout amenable to future indexing.
